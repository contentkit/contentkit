...
import { App, Profile, SignIn, PostEditor, Projects, Playground } from './pages'
...
class AppRouter extends React.Component {
  ...
  render () {
    ...
    const props = {
      logged: Boolean(auth?.user), /* eslint-disable-line */
      loading: auth?.loading, /* eslint-disable-line */
      auth: auth,
