...
class PostEditorContentPreviewDialog extends React.Component {
  state = {
    html: ''
  }
  ...
  static getDerivedStateFromProps (nextProps, prevState) {
    ...
    return { html: unescapeHtml(nextProps.exportHtml(nextProps.editorState)) }
  }
...
export default PostEditorContentPreviewDialog
